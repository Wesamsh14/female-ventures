...
<div id="container">
	...
	<div id="right">
		...
		<a class="logos-top" href="">Talk to us</a>
		</div>
		<div id="donate">
		<i class="fas fa-donate" style="font-size: 2em;"></i><br>
		<a class="logos-top" href="">Donate</a>
		</div>
		<div id="circle">
		<i class="fas fa-user-circle" style="font-size: 2em;"></i><br>
		<a class="logos-top" href="signup">Join Us!</a>
		</div>
		</span>
	</div>
	<div id="logo">
