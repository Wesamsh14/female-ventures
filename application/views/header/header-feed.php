...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
	...
	<body class="home page-template page-template-template-homepage page-template-template-homepage-php page page-id-2 wp-custom-logo et_divi_builder woocommerce-no-js has-featured-image et-pb-theme-sage starter theme et-db et_minified_js et_minified_css">
...
$(document).ready(function(){
    $(".primary").click((){
        $("#navbarsExampleDefault").collapse('toggle');
    });
});
</script>
	<!-- Optional JavaScript -->
